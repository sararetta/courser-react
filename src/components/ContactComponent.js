...
const [touched, setTouched] = useState({
  ...
  function  postFeedback(event) {
    ...
    .then((response )=>{
      ...
      alert('Thank you for your feedback!' + JSON.stringify({firstname:response.firstname,
    ...
    .catch(error =>  { console.log('post leader', error.message); alert('Your leader could not be posted\nError: '+error.message); });
